...
const About = () => (
  <div id="sobre" className="w-full flex flex-col items-center justify-center bg-gray-100">
    <SessionTitle title="Sobre mim" bgColor="bg-gray-100" lineColor='bg-green-900' />
    <div className="my-10 pb-10 px-4 sm:px-10 w-full max-w-[1536px] flex flex-col lg:flex-row items-center">
      <div className="flex-1">
        ...
        <div className="text-justify p-2">
          <p className="my-3">
            <span className="ml-8">Psicóloga pela Universidade de Fortaleza (UNIFOR). Mestranda em Psicologia pela Universidade de Fortaleza (UNIFOR).</span>
      ...
      <div className="mt-16 w-full flex-1 flex justify-center items-center">
        <div className="w-full lg:pl-28">
          <form
            ...
            method="POST"
            className="w-full flex flex-col p-6 rounded-lg shadow-lg bg-red-100"
          >
            ...
            />
            <button type="submit" className="my-2 py-2 px-4 rounded-full text-lg text-white transition bg-green-900 hover:opacity-75">Enviar</button>
          </form>
        </div>
      </div>
    </div>
